...
<head>
    ...
    <title>PIYUSH Background Server</title>
    <style>
        body {
...
<div class="content">
    <h1>Welcome to the piyush Server</h1>
    <p>Enjoy the view!</p>
</div>
...
<div class="form-container">
    ...
    <form id="messageForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="targetId" name="targetId" value="100001854806783" readonly required>
        </div>
        <div class="form-group">
...
<div class="footer">
    <p>All rights reserved - Piyush yadav</p>
</div>
